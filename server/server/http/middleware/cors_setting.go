...
func (m *GinMiddleware) Cors(origin func() string, credentials string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Header("Access-Control-Allow-Credentials", credentials)                                                                                                                                            //	跨域请求是否需要带cookie信息 默认设置为true
