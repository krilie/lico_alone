...
//		a := service.(*Init)
//		// 是否初始化过
//		isInit, err := a.ConfigService.GetValueBool(ctx, common_model.CommonIsInitData)
//		if err != nil {
//			return err
//		}
//		if isInit == nil {
//			err := a.ConfigService.SetValueBool(ctx, common_model.CommonIsInitData, false)
//			if err != nil {
//				return err
//			}
//		} else {
...
//			}
//		}
//		err = a.ConfigService.SetValueBool(ctx, common_model.CommonIsInitData, true)
//		if err != nil {
//			return err
//		}
//		// 初始化第一个角色
...
//			Model:      common_model.Model{Id: adminId, CreateTime: time.Now()},
//			UpdateTime: time.Now(),
//			LoginName:  "admin",
//			PhoneNum:   "",
//			Email:      nil,
