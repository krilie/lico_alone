...
func (h *HttpService) InitAndStartHttpService(ctx context.Context) (shutDown func(waitSec time.Duration) error) {
...

	{
		...
		commonApi.GET("/common/picture/:id", h.ctrl.commonCtrl.GetSlidePicById)    // AboutApp
		commonApi.GET("/common/catchword/query", h.ctrl.commonCtrl.QueryCatchword) // AboutApp
	}
